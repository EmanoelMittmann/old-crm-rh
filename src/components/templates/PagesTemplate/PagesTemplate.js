...
import { SectionTitle, SectionTitleContainer, SectionTitleIcon } from '../../atoms/PageTitle/style'
...
export const PagesTemplate = (props) => {
  ...
  const { name, icon, hasButton, buttonText, buttonPath, isRegisterPage } = props.template
